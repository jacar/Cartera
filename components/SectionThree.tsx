...
const featuredProjects: Project[] = [
  {
    ...
    cat: "Logística / Delivery",
    desc: "Plataforma de gestión de entregas y pedidos en tiempo real.",
    img: "/delivery.png",
    projectUrl: "https://deliveryexpressmg.com/",
    gallery: ["/delivery.png"]
  },
  {
    id: 2,
    name: "Dólar Para Pro",
    cat: "App Móvil / Android",
    desc: "Aplicación Android para consultar el precio del dólar en Venezuela en tiempo real. Incluye monitor BCV, paralelo, Binance P2P, calculadora de vueltos y alertas de variación.",
    img: "/dolarpara.png",
    projectUrl: "https://play.google.com/store/apps/details?id=com.webcincodev.dolarve",
    gallery: ["/dolarpara.png"]
  },
  {
    id: 3,
    name: "Fundación Sofía",
    cat: "ONG / Fundación",
    desc: "Sitio web institucional para Fundación Sofía, organización dedicada al bienestar social y la inclusión.",
    img: "/sofia.jpg",
    projectUrl: "https://www.fundacionsofia.com/",
    gallery: ["/sofia.jpg"]
  },
  {
    id: 4,
    name: "CRM Corporación JF",
    cat: "SaaS / Gestión Empresarial",
    desc: "Sistema CRM a medida para Corporación JF. Gestión de clientes, seguimiento de oportunidades y automatización de procesos comerciales.",
    img: "/crm.jpg",
    projectUrl: "https://crm.corporacionjf.com/",
    gallery: ["/crm.jpg"]
  },
  {
    id: 5,
    name: "Spa Divine Aesthetics",
    cat: "Salud y Estética",
    desc: "Sitio web de lujo para Spa Divine Aesthetics, centro de bienestar y tratamientos estéticos premium.",
    img: "/spadivide.png",
    projectUrl: "https://spadivineaesthetics.com/",
    gallery: ["/spadivide.png"]
  },
  {
    id: 6,
    name: "Focus Creative",
    cat: "Agencia Creativa",
    desc: "Plataforma digital para agencia de marketing y diseño.",
    img: "/focus.png",
    projectUrl: "https://focuscreative.com.co/",
    gallery: ["/focus.png"]
  },
  {
    id: 7,
    name: "Modelet Spa",
    cat: "Salud y Estética",
    desc: "Sitio web corporativo para centro de bienestar y belleza.",
    img: "/modelet.png",
    projectUrl: "https://modeletspa.com/",
    gallery: ["/modelet.png"]
  },
  {
    id: 8,
    name: "Web para Odontólogos",
    cat: "Salud Digital",
    desc: "Plataforma especializada en marketing y diseño para dentistas.",
    img: "/dental.png",
    projectUrl: "https://www.webparaodontologos.com/",
    gallery: ["/dental.png"]
  },
  {
    id: 9,
  ...
  {
    id: 10,
    name: "Mecánico en Medellín",
    cat: "Servicios Automotrices",
    desc: "Plataforma de servicios mecánicos a domicilio y gestión de talleres en la ciudad de Medellín.",
    img: "/meca.png",
    projectUrl: "https://mecanicoenmedellin.com/",
    gallery: ["/meca.png"]
  },
  {
    id: 11,
              ...
              {archiveProjects.map((p) => (
                ...
                >
                  <div className="h-48 overflow-hidden relative">
                    <img src={p.img} alt={p.name} loading="lazy" decoding="async" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 grayscale group-hover:grayscale-0" />
                    {p.projectUrl !== '#' && (
